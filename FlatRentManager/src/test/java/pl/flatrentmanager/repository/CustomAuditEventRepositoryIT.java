package pl.flatrentmanager.repository;

import pl.flatrentmanager.FlatRentManagerApp;
import pl.flatrentmanager.config.Constants;
import pl.flatrentmanager.config.audit.AuditEventConverter;
import pl.flatrentmanager.domain.PersistentAuditEvent;
...
import static pl.flatrentmanager.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
